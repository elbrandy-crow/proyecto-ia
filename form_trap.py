...
# Obtener lista de canciones y sus BPMs
canciones = ["goteo.mp3", "god.mp3", "travis.mp3","hello_coto.mp3",]  # Cambiar nombres de archivos según corresponda
bpm = [148, 130, 150,140]  # BPMs correspondientes a las canciones
...
titulo_label = tk.Label(root, text="TRAP BPM", font=fuente_personalizada, fg="white", bg="black")
titulo_label.pack()
